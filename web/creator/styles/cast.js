...
.mmc-cast-shut, .mmc-cast-keepme, .mmc-cast-swapme, .mmc-cast-modme {
...
.mmc-cast-shut:hover, .mmc-cast-modme:hover:not(:disabled), .mmc-cast-keepme:hover:not(:disabled),
.mmc-cast-swapme:hover:not(:disabled) {
  background: var(--mmc-surface-3); color: var(--mmc-text);
}
.mmc-cast-keepme:disabled, .mmc-cast-swapme:disabled, .mmc-cast-modme:disabled { opacity: .4; cursor: default; }
.mmc-cast-modme.on { color: var(--mmc-accent); }
